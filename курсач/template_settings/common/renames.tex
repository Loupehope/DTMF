...
%%
%%
\newcommand{\Author}{В.В.\,Сухомлинов} % И.О. Фамилия автора 
...
\newcommand{\Supervisor}{И.Н.\,Белых} % И. О. Фамилия научного руководителя
...
\newcommand{\SupervisorJob}{} %
\newcommand{\SupervisorJobVin}{должность} % в винительном падеже (Кого? что?  Програмиста ...)
\newcommand{\SupervisorDegree}{доцент ВШИСиСТ} %
\newcommand{\SupervisorTitle}{к.ф.-м.н.} % 
%%
%%
...
%%
%%
\renewcommand{\thesisTitle}{Распознавание двухтонального многочастотного набора телефонного номера}
...
%%
%%
\newcommand{\group}{3540203/10101} % заменить вместо N номер группы
...
\ifnumequal{\value{docType}}{1}{% Если ВКР, то...
	\newcommand{\DocType}{КУРСОВОЙ ПРОЕКТ}
